...
const en = {
  ...
  grades: {
    ...
    title: 'Grade sheet',
    back: '← Back',
    upload: 'Upload transcript (PDF)…',
    replace: 'Open another…',
    reading: 'Reading…',
    drop: 'Drop a transcript PDF here, or',
    empty: 'Open a BGU transcript (תדפיס לימודים) to see every course the student took, the grade that counts, and the attempts behind it.',
    privacy: 'The file is read in this browser only — nothing is uploaded and nothing is saved.',
    error: 'Could not read the grade sheet: ',
    asOf: 'As of {date}',
    courses: '{n} courses',
    credits: '{n} cr',
    average: 'Average {n}',
    matched: '{n}/{total} in program',
    ...
    attempt: '{grade} · {term} · {moed}',
    inProgram: 'In the program',
    notInProgram: 'Not in the program',
    priorCodes: 'Earlier listed as {codes}',
  },
};
...
const he: Dict = {
  ...
  grades: {
    ...
    title: 'גיליון ציונים',
    back: '← חזרה',
    upload: 'פתיחת תדפיס לימודים (PDF)…',
    replace: 'פתיחת קובץ אחר…',
    reading: 'קורא…',
    drop: 'ניתן לגרור לכאן תדפיס לימודים, או',
    empty: 'יש לפתוח תדפיס לימודים (PDF) כדי לראות את כל הקורסים שהסטודנט למד, את הציון הקובע ואת הניסיונות שקדמו לו.',
    privacy: 'הקובץ נקרא בדפדפן בלבד — הוא אינו נשלח לשום מקום ואינו נשמר.',
    error: 'לא ניתן לקרוא את גיליון הציונים: ',
    asOf: 'נכון ליום {date}',
    courses: '{n} קורסים',
    credits: '{n} נק"ז',
    average: 'ממוצע {n}',
    matched: '{n}/{total} בתוכנית',
    against: 'השוואה מול',
    col: {
      code: 'קורס',
      name: 'שם הקורס',
    ...
    attempt: '{grade} · {term} · {moed}',
    inProgram: 'נמצא בתוכנית',
    notInProgram: 'לא נמצא בתוכנית',
    priorCodes: 'נלמד קודם לכן כ־{codes}',
  },
};
